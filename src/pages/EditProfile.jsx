        ...
        <section class="mt-10 ">
          <form action="/profile.html">
            ...
            <div class="flex justify-center">
              <input onClick={() => { setConfirmationPopUp(true) }} value="Confirm" type='button' class="hover:-translate-y-1 active:translate-y-1 transition-transform text-center w-1/4 rounded-full bg-green-600 text-white py-2 px-4 mx-4 block mt-20 cursor-pointer" />

              <Link to={`/users/profile/${userid}`} class="hover:-translate-y-1 active:translate-y-1 transition-transform text-center w-1/4 rounded-full bg-green-600 text-white py-2 px-4 mx-4 block mt-20" >
