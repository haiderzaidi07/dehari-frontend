...
const Ads = ({ handleFullAdPopUp, ads }) => {
  ...
  const handleClick = () => {
    handleFullAdPopUp(true);
  }

  return (
    <>
      {ads.map(ad => (
        <div key={ad.id} onClick={handleClick} id="ad" className="ad bg-white border-[1px] border-slate-300 text-emerald-400 p-6 active:translate-y-2 hover:scale-105 transition-all duration-500">
