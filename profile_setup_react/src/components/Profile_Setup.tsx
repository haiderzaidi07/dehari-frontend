...
export default function Profile_Setup(props: Profile_SetupProps) {
  return <div className="relative bg-white text-center w-[1440px] h-[1024px] overflow-clip" /*style={props.style}*/  >
      <div  >
...
Profile_Setup.defaultProps = {
  className: "",
  style: {}
};
interface Profile_SetupProps {
  className: string;
  style: Object;
}
